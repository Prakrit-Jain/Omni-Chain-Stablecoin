...
class SprDeployer extends Deployer {
	...
	async deployOnlySPRContracts() {
		...
		if (
			...
			await partialContracts.SPRToken.approve(partialContracts.lockedSpr.address, ethers.constants.MaxUint256)
		}
	...
	async approveSPRTokenAllowanceForCommunityIssuance() {
		...
		if (allowance == 0) {
			await SprContracts.SPRToken.approve(SprContracts.communityIssuance.address, ethers.constants.MaxUint256)
		}
	}
}
